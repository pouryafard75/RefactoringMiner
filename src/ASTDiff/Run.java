...
//        UMLModel model2 = new UMLModelASTReader(new File("D:\\TestCases\\v2")).getUmlModel();
        UMLModel model1 = new UMLModelASTReader(new File("D:\\DebugCases\\spdy\\v1")).getUmlModel();
        UMLModel model2 = new UMLModelASTReader(new File("D:\\DebugCases\\spdy\\v2")).getUmlModel();
