...
public class ReplaceLoopWithPipelineTest {
    ...
    public static void init()
    {
        urls = new String[]{
                ...
                "https://github.com/apache/cassandra/commit/35668435090eb47cf8c5e704243510b6cee35a7b" //4
        };
    }
    ...
    public void test1() throws RefactoringMinerTimedOutException {
        String url = urls[0];
        ProjectASTDiff diff = ProjectASTDiffer.fromURL(url,true).diff();
    ...
    public void test2() throws RefactoringMinerTimedOutException {
        ...
        ProjectASTDiff diff = ProjectASTDiffer.fromURL(url,false).diff();
        new WebDiff(diff).run();
        System.out.println("");
        while(true) { }
    }
    @Test
    public void test3() throws RefactoringMinerTimedOutException {
        String url = "https://github.com/junit-team/junit5/commit/62c433c14ce9d70fa5b82ef385a6e15c22cc0003";
        ProjectASTDiff diff = ProjectASTDiffer.fromURL(url,false).diff();
        new WebDiff(diff).run();
        System.out.println("");
        while(true) { }
