...
public class TextDiffView implements Renderable {
    ...
    public TextDiffView(File srcFile, File dstFile, ASTDiff diff, int id) {
                    ...
                    .div(class_("container-fluid"))
                        ...
                        .div(class_("row"))
                            .div(class_("col"))
                                ...
                                ._h3()
                                .pre(class_("border p-2")).content(ActionsIoUtils.toText(diff.getSrcTC(), diff.getEditScript(), diff.getMappings()).toString())
                            ._div()
                        ._div()
                    ._div()
                ._body()
